...
3. **`.env`** on the host:
   ...
   # PLAY_RATED_FOR_HUMANS=gcp|expectimax-onnx-3   # ;-separated; operator-only — marks these bots eligible for rated human games
   # PLAY_RETIRED_BOTS=lab|old-bot   # ;-separated; takes these bots off the ladder AND out of the human catalog at boot
   ```
